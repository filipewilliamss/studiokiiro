    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-transparent">
      ...
      <div className="absolute inset-0 z-0 pointer-events-auto overflow-hidden flex items-center justify-center">
        <iframe 
          ...
          frameBorder="0" 
          className="w-full h-full lg:w-screen lg:h-screen scale-[1.03] transition-all duration-700"
          style={{ border: 'none' }}
      ...
      <div className="relative z-10 container-editorial text-center py-20 pointer-events-none">
        <motion.div
          ...
          className="flex flex-col sm:flex-row gap-6 justify-center pointer-events-auto mt-[calc(60vh+150px)] sm:mt-[calc(50vh+150px)] md:mt-[calc(40vh+150px)]"
        >
          <a
            href="#portfolio"
      ...
      <div className="absolute bottom-0 right-0 w-[170px] h-[60px] bg-[#070807] z-10 pointer-events-none" />
    </section>
  );
};
