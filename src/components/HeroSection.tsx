    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-transparent">
      ...
      <div className="absolute inset-0 z-0 pointer-events-auto overflow-hidden">
        <iframe 
          ...
          width="100%" 
          height="100%"
          className="w-full h-full scale-[0.8] sm:scale-[0.85] lg:scale-100 transition-transform duration-700 origin-center lg:origin-bottom translate-y-20 sm:translate-y-16 lg:translate-y-0"
          style={{ border: 'none' }}
      ...
      <div className="relative z-10 container-editorial text-center py-20 pointer-events-none">
        <motion.div
          ...
          className="flex flex-col sm:flex-row gap-6 justify-center pointer-events-auto mt-[calc(60vh+100px)] sm:mt-[calc(50vh+100px)] md:mt-[calc(40vh+100px)]"
        >
          <a
            href="#portfolio"
