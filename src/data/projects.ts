...
export const projects: Project[] = [
  ...
  },
  {
    ...
    biblicalSimbology: "Cada detalhe do símbolo histórico carrega um profundo significado espiritual, fundamentado nas Escrituras:\n\n– O Leão: Representa Jesus, nosso Salvador. Aquele que veio primeiramente como o Cordeiro de Deus e que retornará em majestade, autoridade e vitória como o Leão da tribo de Judá. (Apocalipse 5:5)\n\n– A Coroa: Simboliza a vitória absoluta de Cristo sobre o pecado e a morte. Representa também a promessa da coroa incorruptível de glória reservada àqueles que nEle permanecem em obediência. (Hebreus 2:9 / 1 Pedro 5:4)\n\n– A Cruz: Representa a poderosa obra redentora de Jesus Cristo no Calvário, o perdão de todas as ofensas e o triunfo definitivo sobre os principados e potestades. (Colossenses 2:13-15)\n\n– A Águia: Remete a um dos quatro seres viventes que estão diante do trono de Deus, adorando-O incessantemente e declarando Sua santidade, honra e poder para todo o sempre. (Apocalipse 4:6-11)\n\n– As Chamas de Fogo: Simbolizam a presença viva, o batismo e o poder purificador do Espírito Santo, que reveste e capacita a Igreja para a sua missão. (Mateus 3:11)\n\n– A Silhueta de Anjos: (Entre a águia e os olhos do leão) Faz referência aos serafins que cercam o alto e sublime trono do Senhor, proclamando uns aos outros que a terra inteira está cheia da Sua glória. (Isaías 6:2-3)",
