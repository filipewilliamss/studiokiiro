...
import { LogOut, Users, FolderKanban, DollarSign, FileText, Receipt, Layers, BarChart3, Clock, BookOpen, Send, Key, Sparkles } from "lucide-react";
...
const tabs = [
  ...
  { key: "cases", label: "Cases", icon: Sparkles },
