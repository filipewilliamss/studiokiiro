    ...
    <section id="sobre" className="section-padding">
      <div className="container-editorial">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 lg:gap-x-24 gap-y-12 items-start">
          ...
          {/* Top Right: First two text blocks */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: false, amount: 0.3 }}
            transition={{ duration: 0.7, delay: 0.2 }}
            className="space-y-6 md:col-span-1 md:pt-32 lg:pt-48"
          >
          ...
          {/* Bottom: Last two text blocks */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: false, amount: 0.3 }}
            transition={{ duration: 0.7, delay: 0.4 }}
            className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-x-12 lg:gap-x-24 gap-y-6"
          >
            <p className="text-base text-muted-foreground leading-relaxed">
