...
import { DollarSign, Plus, Calendar, CreditCard, TrendingUp } from "lucide-react";
      ...
      <div className="grid gap-3">
        {payments.length === 0 ? (
          ...
          payments.map((payment) => {
            ...
            return (
              <div key={payment.id} className="bg-card border border-border rounded-xl p-5 space-y-3">
